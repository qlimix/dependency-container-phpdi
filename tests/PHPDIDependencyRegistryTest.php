...
use Qlimix\DependencyContainer\PHPDIDependencyRegistry;
use stdClass;

final class PHPDIDependencyRegistryTest extends TestCase
{
    private Container $container;

    private PHPDIDependencyRegistry $registry;

    protected function setUp(): void
    {
        $this->container = new Container();
        $this->registry = new PHPDIDependencyRegistry($this->container);
    }
